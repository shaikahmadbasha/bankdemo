...
import com.capg.authservice.handler.UserApprovalHandler;
...
public class OAuth2Config extends AuthorizationServerConfigurerAdapter {
	...
	@Value("${authservice.token.validitytime}")
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		...
		// setting default token TTL to 2 mins
		.accessTokenValiditySeconds(tokenValidityTime!=null?Integer.valueOf(tokenValidityTime):120)
		.and()
